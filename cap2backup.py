        ...
        if(i<0.5):
            ...
            for ii in req_tfidf_2:
                ...
                if(ii<0.4):
                    ...
                    robo_response.append(null)
                    robo_response.append(3)
                    return robo_response
                else:
                    robo_response.append(l2[3][idx_2][ii])
                    robo_response.append(l2[4][idx_2][ii])
                    robo_response.append(2)   
                    return (robo_response + ii)
        else:
